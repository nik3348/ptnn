...
class Wrapper(gym.Wrapper):
    ...
    def reset(self):
        ...
        state_size = self.env.observation_space.shape[0] * self.max_seq_len
        ...
        masked_input_array = masked_input_array.reshape((self.max_seq_len, self.env.observation_space.shape[0]))
